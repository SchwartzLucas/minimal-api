...
public class Startup{
    ...
    public void Configure(IApplicationBuilder app, IHostingEnvironment env){
        ...
        endpoints.MapPost("/administradores/login", ( [FromBody] LoginDTO loginDTO, [FromServices] iAdministradorServico administradorServico) => {
            ...
            if(adm != null){
                ...
                return Results.Ok(new AdministradorLodago{
                    Email = adm.Email,
                    Perfil = adm.Perfil,
                    Token = token
                });
        ...
        endpoints.MapPost("/administradores", ( [FromBody] AdministradorDTO administradorDTO, [FromServices] iAdministradorServico administradorServico) => {
        ...
        endpoints.MapPost("/veiculos", ( [FromBody] VeiculoDTO veiculoDTO, [FromServices] iVeiculoServico veiculoServico) => {
